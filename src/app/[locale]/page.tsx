...
import { getHomeFeaturedPortfolioItem } from '@/lib/queries/portfolio'
...
export default async function HomePage(props: Props) {
  ...
  const featuredPortfolio = await getHomeFeaturedPortfolioItem(locale)

  return (
    <>
      <Hero />
      <Process />
      <Portfolio featured={featuredPortfolio} />
      <Services />
