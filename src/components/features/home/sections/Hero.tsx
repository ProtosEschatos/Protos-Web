      ...
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        <div className="max-w-[700px]">
          ...
          <motion.div custom={3} initial="hidden" animate="visible" variants={fadeUp} className="flex gap-4 flex-wrap mb-16">
            ...
            <TransitionLink href="/portfolio-showcase?focus=poklon" className="inline-flex items-center gap-2 px-7 py-3 rounded-full border border-[#a78bfa]/50 bg-[#6366f1]/10 text-[#ddd6fe] text-xs font-semibold uppercase tracking-wider hover:border-[#a78bfa] hover:bg-[#6366f1]/25 transition-all duration-300">
