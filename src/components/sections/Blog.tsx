  ...
  return (
    <section className="py-24">
      <div className="max-w-[1200px] mx-auto px-6 text-center">
        ...
        <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-extrabold leading-tight mb-5">Web Academy</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {posts.map((p, i) => (
            <motion.div
              ...
              className="bg-[var(--dark-card)] border border-[var(--border-card)] rounded-2xl p-7 text-left flex flex-col hover:border-[var(--primary)]/20 hover:-translate-y-1 transition-all duration-300 group"
            >
        ...
        <div className="mt-10">
          ...
          >
            View All Articles <i className="fas fa-arrow-right text-[0.75rem]" />
          </Link>
        </div>
      </div>
    </section>
