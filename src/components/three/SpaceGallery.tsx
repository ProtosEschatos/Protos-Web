  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh position={[0, 1.85, -0.22]} castShadow>
        ...
        <meshStandardMaterial color={0x111827} roughness={0.05} metalness={0.95} emissive={0x1e3a5f} emissiveIntensity={0.3} />
      </mesh>
      ...
      <mesh ref={leftArmRef} position={[-0.55, 1.05, 0]} rotation={[0, 0, 0.2]} castShadow>
        <cylinderGeometry args={[0.1, 0.1, 0.75, 12]} />
        <meshStandardMaterial color={0xffffff} roughness={0.3} metalness={0.1} />
      </mesh>
      <mesh ref={rightArmRef} position={[0.55, 1.05, 0]} rotation={[0, 0, -0.2]} castShadow>
        <cylinderGeometry args={[0.1, 0.1, 0.75, 12]} />
        <meshStandardMaterial color={0xffffff} roughness={0.3} metalness={0.1} />
      </mesh>
      <mesh position={[-0.18, 0.35, 0]} castShadow>
        <cylinderGeometry args={[0.12, 0.12, 0.7, 12]} />
        <meshStandardMaterial color={0xeeeeee} roughness={0.35} metalness={0.1} />
      </mesh>
      <mesh position={[0.18, 0.35, 0]} castShadow>
        <cylinderGeometry args={[0.12, 0.12, 0.7, 12]} />
        <meshStandardMaterial color={0xeeeeee} roughness={0.35} metalness={0.1} />
