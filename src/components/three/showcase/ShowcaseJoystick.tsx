...
export function ShowcaseJoystick({ touchInput }: ShowcaseJoystickProps) {
  ...
  return (
    <div
      ref={baseRef}
      className="fixed bottom-24 left-5 z-30 touch-none select-none md:hidden"
      style={{ width: OUTER, height: OUTER }}
      onPointerDown={onPointerDown}
      onPointerMove={onPointerMove}
      onPointerUp={onPointerUp}
      onPointerCancel={onPointerUp}
      aria-label="Move astronaut"
      role="application"
    >
      <div className="absolute inset-0 rounded-full border border-white/15 bg-black/45 backdrop-blur-md shadow-[0_0_24px_rgba(99,102,241,0.15)]" />
      <div
        ref={knobRef}
