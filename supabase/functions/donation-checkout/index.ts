...
async function createStripeCheckoutSession(params: {
  ...
  // Use Dashboard payment-method configuration (cards, Apple/Google Pay, Klarna, Link, …)
  body.set('payment_method_configuration', 'pmc_1T1d1IKt4cjFylv1eKoflnsw')
  body.set('locale', params.locale === 'hr' ? 'hr' : params.locale)
